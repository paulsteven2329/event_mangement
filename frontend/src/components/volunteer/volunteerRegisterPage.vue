    ...
    <div class="register-container">
      ...
      <div class="form-container">
        <form @submit.prevent="register" class="register-form">
          ...
          <div class="input-group">
            <textarea
              v-model="volunteer_experience"
              placeholder="Briefly describe your volunteer experience"
              class="input-field"
            ></textarea>
          </div>
        ...
        <p class="login-link">Already have an account? 
          <router-link to="/VolunteerLoginForm">Login</router-link>
        </p>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      async register() {
        ...
        try {
          const response = await axios.post('http://localhost:3000/volunteer/register', {
            ...
            volunteer_experience: this.volunteer_experience,
          });
      ...
      async checkIfEmailExists(email) {
        try {
          const response = await axios.get(`http://localhost:3000/volunteer/email-check?email=${email}`);
