...
methods: {
  async fetchProfile() {
    const email = localStorage.getItem('student_email');  // Retrieve email from localStorage
    ...
    try {
      ...
      if (response.data.status === 'success') {
        ...
        // You can store or display the profile data as needed
        this.profile = response.data.data;

        // Example of displaying data in the profile component
        console.log(`Phone Number: ${this.profile.phone_number}`);
        console.log(`Location: (${this.profile.location_latitude}, ${this.profile.location_longitude})`);
        console.log(`Registration Date: ${this.profile.registration_date}`);
      } else {
